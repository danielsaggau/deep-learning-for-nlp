...
In an RNN, at a given point in time j, the information about all past is “crammed” into the state vector
...
But when presented with sufficient data, it usually outperforms them After Christmas: Transfer learning as a way to pretrain Transformers
on lots of data
